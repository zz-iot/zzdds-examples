...
def build_all(zig_out: Path) -> bool:
    ...
    for bin_ in (
        ZIG_DIR / "zig-out" / "bin" / "discovery_pub",
        ZIG_DIR / "zig-out" / "bin" / "discovery_sub",
        C_DIR / "build" / "discovery_pub",
        C_DIR / "build" / "discovery_sub",
        CPP_DIR / "build" / "discovery_pub",
        CPP_DIR / "build" / "discovery_sub",
    ):
        if not bin_.is_file():
...
def pub_cmd(lang: str, zig_out: Path) -> list[str]:
    return {
        "zig": [str(ZIG_DIR / "zig-out" / "bin" / "discovery_pub")],
        "c": [str(C_DIR / "build" / "discovery_pub")],
        "cpp": [str(CPP_DIR / "build" / "discovery_pub")],
...
def sub_cmd(lang: str, zig_out: Path) -> list[str]:
    return {
        "zig": [str(ZIG_DIR / "zig-out" / "bin" / "discovery_sub")],
        "c": [str(C_DIR / "build" / "discovery_sub")],
        "cpp": [str(CPP_DIR / "build" / "discovery_sub")],
