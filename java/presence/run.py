#!/usr/bin/env python3
"""Runs the zzdds Java presence example: Subscriber and Publisher as two
...
# Total runtime is ~13s (8 online writes @ 500ms + 5s deliberate offline
# pause + 8 more writes @ 500ms) -- see
# docs/design/presence-reference-app.md. Generous ceiling beyond that in
