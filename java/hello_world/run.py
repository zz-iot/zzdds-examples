...
# hello_world's own binaries self-terminate once they've written/received
# all 10 samples and torn down (see docs/design/hello-world-reference-app.md)
# -- no external signaling needed, just a generous ceiling in case something
# hangs.
PROC_TIMEOUT_S = 20
